    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_fraud_check_records", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_fraud_check_records_MerchantId_CreatedAt",
                table: "fraud_check_records",
                columns: new[] { "MerchantId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_fraud_check_records_PaymentId",
                table: "fraud_check_records",
                column: "PaymentId",
                unique: true);
